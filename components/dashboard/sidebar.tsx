...
export function Sidebar({ user, userRole, collapsed, onCollapsedChange }: SidebarProps) {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isCollapsed && item.badge && (
                          <span className="absolute right-1.5 top-1.5 h-2 w-2 rounded-full bg-primary ring-2 ring-background"></span>
                        )}
